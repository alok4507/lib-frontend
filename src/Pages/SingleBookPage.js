  ...
  return (
    <>
      ...
      <div
        ...
        className="w[100%] h-max pb-20 bg-gradient-to-b from-white-800 to-gray-700 pt-[80px] overflow-x-hidden"
      >
        ...
        <div className="flex flex-col justify-center items-center w-[100%]">
          <p className="font-bold text-black text-3xl sm:text-xl">
          ...
          <p className="mt-7 text-5xl md:text-4xl sm:text-2xl font-bold text-black">
            Related Books
          </p>
