...
const FavouritePage = () => {
  ...
  return (
    <>
      <Header />
      <div className="w[100%] min-h-[100vh] max-h-[100%] bg-gradient-to-b from-white-800 to-gray-700 pt-[130px] md:pl-5 md:pt-[80px] pb-20">
        <p
          style={{
            translate: msg ? "0%" : "-100%",
          }}
          className="bg-emerald-600 z-50 fixed top-24 left-0 p-2 pl-5 text-lg  ease-in-out duration-300 text-black shadow-lg border-[2px] border-emerald-900"
        >
