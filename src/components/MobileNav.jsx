...
const MobileNav = ({ status }) => {
  ...
  return (
    <div className="fixed md:flex z-20 justify-around items-center bottom-2 left-2 right-2 bg-gradient-to-br from-slate-200 to-slate-200 p-3 rounded-xl hidden">
      {icons.map((icon, idx) => {
        return (
          <div
            style={{
            ...
            key={idx}
            className="text-black text-2xl z-10 cursor-pointer py-1 px-2 rounded-lg"
          >
            {icon.iconName}
          </div>
        );
