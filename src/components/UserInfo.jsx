  ...
  return (
    <>
      <p className="text-lg text-gray-300 font-semibold bg-pink-800 py-2 px-2 rounded-md sm:w-[100%] sm:mt-5">
        Hello, <span className="text-black">{user?.username}</span>
      </p>
      ...
      <div className="flex flex-col justify-center items-start mt-5">
        {user?.isAdmin && (
          <button
            ...
            className="p-3 w-[100%] rounded-md bg-emerald-600 text-black font-semibold text-lg shadow-sm"
          >
            View Dashboard
          </button>
        )}
        <button
          ...
          className="p-3 mt-3 w-[100%] rounded-md bg-red-500 text-black font-semibold text-lg shadow-sm"
        >
          Logout
        </button>
      </div>
...
className=" bg-gradient-to-r from-slate-600 to-slate-500 text-black font-semibold flex justify-between items-center  shadow-sm p-3 w-[100%] mt-5 rounded-md cursor-pointer"
>
<p>Books In Hand</p>
<AiOutlineDown />
</div>
...
className=" bg-gradient-to-br from-bg-gradient-to-r from-slate-600 to-slate-500 text-black font-semibold flex justify-between items-center shadow-sm p-3 w-[100%] mt-5 rounded-md cursor-pointer"
>
<p>Rented History</p>
<AiOutlineDown />
</div>
