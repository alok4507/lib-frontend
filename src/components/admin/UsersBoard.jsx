  ...
  return (
    <div className="w-[95%] h-max overflow-x-scroll scrollbar">
      <table className="w-[100%] border-collapse ">
        <thead>
          <tr className="bg-slate-800 text-black border-[1px] border-slate-200">
            {data?.map((data, idx) => {
              return (
                <th
                  key={idx}
        ...
        <tbody>
          {userData?.map((data, idx) => {
            return (
              <tr
                key={idx}
                className="bg-slate-500 text-black border-[1px] border-slate-200"
              >
      ...
      {modal && (
        <div className="absolute top-[15%] p-5 rounded-md shadow-xl left-[45%] sm:left-[5%] w-[450px] xsm:w-[98%] xsm:left-1 xsm:mt-1 xsm:p-2 h-max bg-slate-200">
          ...
          >
            ...
            <button
              type="submit"
              className="mx-auto w-[200px] text-black font-semibold bg-emerald-600 p-2 rounded-lg mt-2 shadow-md"
            >
              Update
            </button>
          </form>
