...
const className =
  "bg-slate-500 px-4 py-3 w-[400px] sm:w-[90%] mb-5 text-black rounded-2xl outline-none";
...
const CreateBook = () => {
  ...
  return (
    <div className="w-[85%] sm:w-[100%] h-[100%] pb-10 flex justify-between items-center">
      {message && (
        <p className="absolute top-24 rounded-md shadow-lg left-[28%] bg-emerald-600 text-black p-2">
          {message}
        </p>
      )}
      <form
      ...
      >
        ...
        <button
          value="submit"
          type="submit"
          className="bg-pink-700 px-4 py-3 w-[400px] sm:w-[90%] mb-3 text-black rounded-2xl outline-none"
        >
          Create Book
        </button>
      </form>
      <div className="sm:hidden w-[500px] sm:w-[100%] sm:h-[300px] h-[500px]">
        <img className="w-[100%] h-[100%]" src={createImg} alt=""></img>
      </div>
    </div>
  );
};
