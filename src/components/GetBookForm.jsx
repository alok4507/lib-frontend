...
const GetBookForm = ({ defaultDetail }) => {
  ...
  return (
    <div className="ml-64 md:ml-5 sm:ml-0 sm:mt-7 sm:w-[100%]">
      {request?.bool && (
        <div className="absolute left-[42%] shadow-gray-700 shadow-lg rounded-lg ease-in duration-150 text-black mt-5 bg-emerald-600 py-2 px-3 font-semibold text-lg">
          {request?.condt === "Sent" ? (
      ...
      <p className="text-5xl md:text-4xl sm:text-2xl font-bold text-black sm:text-center">
        Request Form
      </p>
      <form
        onSubmit={handleForm}
      ...
      >
        <input
          className="bg-slate-500 px-4 py-3 w-[400px] sm:w-[90%] mb-3 text-black rounded-2xl outline-none"
          type="text"
        ...
        <div className="flex justify-between items-center w-[400px] sm:w-[90%] mb-3">
          <div className="flex flex-col justify-center items-start">
            ...
            <input
              ...
              id="from"
              className="bg-slate-500 px-4 py-3 sm:text-sm mt-1 w-[180px] sm:w-[160px] mb-3 text-black rounded-2xl outline-none"
              type="date"
              required
              min={min1}
            ></input>
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="bg-slate-500 sm:text-sm px-4 py-3 mt-1 w-[180px] sm:w-[160px] mb-3 text-black rounded-2xl outline-none"
              type="date"
              required
              min={min2}
            ></input>
        ...
        <div className="relative">
          ...
          <input
            className="bg-slate-500 px-10 py-3 w-[400px] sm:w-[90%] mb-3 text-black rounded-2xl outline-none"
            type="number"
            placeholder="Amount"
        ...
        <button
          type="submit"
          className="w-[400px] sm:w-[90%] bg-pink-700 p-3 mt-3 text-black font-semibold rounded-xl text-lg"
        >
          Request the Book
        </button>
      </form>
